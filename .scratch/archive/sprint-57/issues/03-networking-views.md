---
id: "03"
title: "UX: barra de seleção em Networking (Services, Ingress)"
status: done
...
Aplica a infraestrutura da issue 01 às 2 views de Networking. Ambas tinham apenas Delete+Manifest na coluna de ações — a coluna é removida e as ações migram para a barra de título, operando sobre o item selecionado.
...
|---|---|---|
| ServicesView | — (coluna removida) | Delete (canDelete), Manifest |
| IngressView | — (coluna removida) | Delete (canDelete), Manifest |
